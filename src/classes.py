...
for j in range(4, r_count):
    ...
    g.serialize(destination="/Users/nakamurasatoru/git/d_nagai/hpdb2/src/static/api/classes/"+id+".json", format='json-ld')

all.serialize(destination="data/classes.rdf", format='pretty-xml')